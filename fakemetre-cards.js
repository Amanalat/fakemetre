...
function buildExpert(src){
  ...
  const av=lc.includes('vétér')||lc.includes('veter')?'🐾':lc.includes('astronaute')||lc.includes('astronaut')?'🚀':lc.includes('botanist')||lc.includes('botaniste')?'🌿':lc.includes('météo')||lc.includes('weather')?'🌤️':lc.includes('archéo')||lc.includes('archeo')?'🏺':lc.includes('ingénieur')||lc.includes('engineer')?'⚙️':lc.includes('historien')||lc.includes('historian')?'📜':lc.includes('coach')?'🎯':lc.includes('nutritio')?'🥗':lc.includes('neurolog')?'🧠':lc.includes('pédiatr')||lc.includes('pediatr')?'👶':lc.includes('sage-femme')||lc.includes('midwife')?'🤱':lc.includes('chimiste')||lc.includes('chemist')?'⚗️':lc.includes('policier')||lc.includes('police')?'👮':lc.includes('entomolog')?'🦋':lc.includes('prof')||lc.includes('enseign')||lc.includes('instit')||lc.includes('teacher')?'👨‍🏫':'🧑‍⚕️';
